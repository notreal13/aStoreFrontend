...
describe('Controller: SupportingDocumentAdminController', function() {
    ...
    beforeEach(inject(function(_$rootScope_, $controller, _$log_, _$state_, _$httpBackend_, _$q_) {
        ...
        $httpBackend.whenGET('http://localhost:8080/rest/document').respond([]);
        ...
        $scope = $rootScope.$new();
        ctrl = $controller('SupportingDocumentAdminController', {
            '$scope': $scope,
